...
@Tag(name = "캐릭터 API", description = "캐릭터 관리 관련 API")
public class CharacterController {
    ...
    @Operation(summary = "닉네임 중복 확인", description = "캐릭터 닉네임의 중복 여부를 확인합니다.")
     ...
     */
    @GetMapping("/me")
    @Operation(summary = "내 캐릭터 조회", description = "현재 로그인한 회원의 캐릭터 정보를 조회합니다.")
    ...
    @Operation(summary = "캐릭터 닉네임 수정", description = "캐릭터의 닉네임을 수정합니다.")
